...
*/var MultiIndex, internalSomeIndexes;
...
MultiIndex = (function() {
  ...
  */
  MultiIndex.prototype.index = function(id, indexes) {
    ...
    internalSomeIndexes(indexes, __bind(function(indexName, indexValue) {
  ...
  */
  MultiIndex.prototype.remove = function(indexes) {
    ...
    if (typeof indexes === 'object') {
      items = this.internalGet(indexes);
    } else {
    ...
    for (_i = 0, _len = items.length; _i < _len; _i++) {
      item = items[_i];
      id = item.id;
      internalSomeIndexes(item.indexes, __bind(function(indexName, indexValue) {
  ...
  */
  MultiIndex.prototype.some = function(indexes, callback) {
    this.internalSome(indexes, function(item) {
  ...
  */
  ...
  MultiIndex.prototype.internalGet = function(indexes) {
    var result;
    result = [];
    this.internalSome(indexes, function(item) {
      result.push(item);
  ...
  MultiIndex.prototype.internalGetOne = function(indexes) {
    var result;
    result = null;
    this.internalSome(indexes, function(item) {
      result = item;
  ...
  MultiIndex.prototype.internalSome = function(indexes, callback) {
    var tmp;
    tmp = {};
    internalSomeIndexes(indexes, __bind(function(indexName, indexValue) {
      var id, ids, _ref;
  ...
  MultiIndex.prototype.internalSetIndex = function(indexName, indexValue, id) {
    if (!(this.indexes[indexName] != null)) {
      this.indexes[indexName] = {};
    }
    if (!(this.indexes[indexName][indexValue] != null)) {
...
/* example of indexes {DNs:['1234','2345'],username:'andrew',id:1243455}
    ...
    - callback 'id', 1243455
*/
internalSomeIndexes = function(indexes, callback) {
